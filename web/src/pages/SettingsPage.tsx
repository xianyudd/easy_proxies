  ...
  return <div className="page settings-page">
    ...
    <div className="settings-layout refined-settings-layout">
      <div className="side-nav settings-anchor-nav">
        ...
        <a href="#pool"><span className="nav-kicker">02</span><strong>默认代理池</strong><span>监听地址和认证</span></a>
        <a href="#multi-port"><span className="nav-kicker">03</span><strong>多端口</strong><span>批量端口出口</span></a>
        <a href="#routing"><span className="nav-kicker">04</span><strong>地区 / Android</strong><span>GeoIP 与移动端代理</span></a>
        <a href="#quality-check"><span className="nav-kicker">05</span><strong>质量检测</strong><span>定时刷新评分缓存</span></a>
        <a href="#management"><span className="nav-kicker">06</span><strong>管理与日志</strong><span>控制面与日志策略</span></a>
      </div>
