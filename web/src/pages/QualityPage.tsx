...
export function QualityPage() {
  ...
  return <div className="page">
    ...
    <div className="charts-grid quality-charts"><div className="chart-panel"><div className="chart-title">CF 评分分布 <span>Compatibility Levels</span></div><CfDistributionChart rows={cfRows} /></div><div className="chart-panel"><div className="chart-title">IP 风险等级 <span>Reputation Risk</span></div><ReputationRiskChart rows={repRows} /></div><div className="chart-panel wide"><div className="chart-title">CF 高分节点排行 <span>Top Score Nodes</span></div><CfScoreRankChart rows={rows} /></div></div>
